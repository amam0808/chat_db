...
<link rel="stylesheet" type="text/css" href="./css/tasklist.css?0949">
...
<body>
            ...
            <?php foreach ($tasks as $task) : ?>
                <ul class="accordion-area">
                    <li class="task__item">
                        ...
                        <button class="task__button" onclick="toggleApproval(this)">未承認</button>
                        </section>
                    </li>
                    <?php endforeach; ?>
                </ul>
        <div class="create_task_button">
          <a href="create_task2.php">新規タスク作成</a>
        </div>
    </div>
    </div>
    <footer class="footer">
    ...
    <script src="./js/taskwait.js"></script>
</body>
</html>
