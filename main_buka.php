...
<link rel="stylesheet" type="text/css" href="./buka/css/main_buka.css">
        ...
        <div class="main-menu">
            ...
            <div class="menu-icon">
                <a href="main_buka.php">
                  <img src="./img/main.png" alt="メイン" width="70px">
                </a><br>
            ...
            <div class="menu-icon">
                ...
                <a href="pro-member-list-buka.php">MEMBER LIST</a>
            </div>
            <div class="menu-icon">
